...
import CopyrightDarkIcon from "../ui/icons/CopyrightDarkIcon";
import CopyrightLightIcon from "../ui/icons/CopyrightLightIcon";
  ...
  return (
    <footer className="w-full space-y-4 bg-indigo-400 px-2 py-3 text-center text-xs sm:space-y-2.5 sm:px-3 sm:py-4 sm:text-sm md:space-y-3 md:px-4 md:py-5 md:text-sm lg:space-y-3.5 lg:px-5 lg:py-6 lg:text-base dark:bg-slate-600">
      ...
      <div>
        ...
        <p>
          {isDark ? (
            <CopyrightDarkIcon className="mr-0.5 mb-0.5 inline-block h-3 w-3 sm:h-4 sm:w-4 md:mb-1 md:h-4.5 md:w-4.5 lg:h-5 lg:w-5" />
          ) : (
            <CopyrightLightIcon className="mr-0.5 mb-0.5 inline-block h-3 w-3 sm:h-4 sm:w-4 md:mb-1 md:h-4.5 md:w-4.5 lg:h-5 lg:w-5" />
          )}
