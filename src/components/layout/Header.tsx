...
export default function Header() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <header className="lg:mg-6 xl:mg-7 md:ml-4 mx-2 mb-2 flex max-w-3xl items-center justify-between rounded-4xl border border-gray-300 bg-slate-200 px-4 py-3 shadow-xl sm:mx-3 sm:mb-3 sm:px-5 sm:py-4 md:mb-5 md:flex-col md:justify-start md:gap-3 md:max-h-70 lg:flex-row lg:justify-between lg:mb-6 xl:mb-7 dark:bg-slate-800">
        <Logo />
        <div>
          <UserInformation />
        </div>
