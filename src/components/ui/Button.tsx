...
export default function Button({ type, size, onClick, children }: ButtonProps) {
  ...
  switch (type) {
    ...
    case "normal":
      typeStyle =
        "w-full bg-stone-900 text-stone-50 font-bold shadow-stone-900 border-stone-600 hover:bg-stone-800 dark:bg-stone-100 dark:shadow-stone-100 dark:border-stone-300 dark:hover:bg-stone-200 dark:text-stone-950";
      break;
    default:
  ...
  switch (size) {
    case "small":
      sizeStyle =
        "text-xs md:text-sm lg:text-base px-1 py-1.5 sm:px-1.5 sm:py-2 md:p-2 lg:py-3";
      break;
    case "medium":
      sizeStyle =
        "text-sm md:text-base lg:text-lg px-2 py-2.5 sm:px-2.5 sm:py-3 md:px-3.5 lg:py-4";
      break;
    case "large":
      sizeStyle =
        "text-base md:text-lg lg:text-xl px-4 py-4.5 sm:px-5 md:py-5 md:px-6 lg:px-6.5";
      break;
    default:
