...
export default function MediaCard({ socialMedia }: MediaCartProps) {
  return (
    ...
    >
      <Link
        className={`flex cursor-pointer items-center gap-1.5 shadow-md shadow-neutral-950 sm:gap-2 ${socialMedia.bgStyle} rounded-md px-2 py-1 sm:py-1.5 md:px-2.5 lg:py-2`}
      ...
      >
        ...
        <span
          className={`font-bold text-xs not-italic sm:text-sm lg:text-base ${socialMedia.textStyle}`}
        >
          {socialMedia.name}
        </span>
      </Link>
