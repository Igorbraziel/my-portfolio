...
const media = [
  {
    ...
    bgStyle: "bg-gradient-to-tr from-sky-600 via-blue-600 to-indigo-500 dark:from-sky-800 dark:via-blue-800 dark:to-indigo-800",
  ...
  },
  {
    ...
    bgStyle: "bg-gradient-to-tr from-neutral-800 via-gray-800 to-stone-700 dark:from-neutral-900 dark:via-gray-900 dark:to-stone-800",
  ...
  },
  {
    ...
    bgStyle: "bg-gradient-to-tr from-rose-500 via-pink-500 to-fuchsia-500 dark:from-rose-800 dark:via-pink-800 dark:to-fuchsia-700",
